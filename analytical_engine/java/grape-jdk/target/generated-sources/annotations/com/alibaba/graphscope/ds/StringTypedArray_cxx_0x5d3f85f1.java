...
public class StringTypedArray_cxx_0x5d3f85f1 extends BaseTypedArray_cxx_0x708692cf implements StringTypedArray {
  ...
  public StringView get(long index) {
    long ret$ = nativeGet(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.StringView_cxx_0x58a38028.SIZE), index); return (new com.alibaba.graphscope.ds.StringView_cxx_0x58a38028(ret$));
  }
