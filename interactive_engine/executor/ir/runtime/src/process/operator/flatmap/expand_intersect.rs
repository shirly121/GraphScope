...
struct ExpandAndIntersect<E: Entry, IE: Into<E>> {
...
impl<E: Entry, IE: Into<E>> ExpandAndIntersect<E, IE> {
    fn init() -> Self {
        ExpandAndIntersect {
            start_v_tags: vec![],
            end_v_tag: 0,
...
impl<E: Entry, IE: Into<E> + 'static> FlatMapFunction<Record<E>, Record<E>> for ExpandAndIntersect<E, IE> {
...
impl<E: Entry> FlatMapFuncGen<E> for algebra_pb::ExpandAndIntersect {
    fn gen_flat_map(
        self,
