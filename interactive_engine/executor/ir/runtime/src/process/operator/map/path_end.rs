...
impl<E: Entry> MapFunction<Record<E>, Record<E>> for PathEndOperator {
    fn exec(&self, mut input: Record<E>) -> FnResult<Record<E>> {
        let entry = input
            .get(None)
...
impl<E: Entry> MapFuncGen<E> for algebra_pb::PathEnd {
