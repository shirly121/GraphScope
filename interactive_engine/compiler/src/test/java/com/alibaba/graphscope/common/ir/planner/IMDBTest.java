...
public class IMDBTest {
    ...
    public void imdb_test() {
        ...
        RelNode before =
                com.alibaba.graphscope.cypher.antlr4.Utils.eval(
                                "MATCH\n"
                                    ...
                                    + "  AND (mi.info CONTAINS 'Japan:.*200' OR mi.info CONTAINS"
                                    + " 'USA:.*200')\n"
                                    + "  AND n.gender = 'f'\n"
        ...
        ////                                        "  AND k.keyword = 'computer-animation'\n" +
        ////                                        "  AND mi.info IS NOT NULL\n" +
        ////                                        "  AND (mi.info CONTAINS 'Japan:.*200' OR
        // mi.info CONTAINS 'USA:.*200')\n" +
        //                                        "  AND n.gender = 'f'\n" +
        //                                        "  AND n.name CONTAINS 'An'\n" +
        //                                        "  AND rt.role = 'actress'\n" +
        //                                        "  AND t.title = 'Shrek 2'\n" +
        ...
        VolcanoPlannerX plannerX = (VolcanoPlannerX) optimizer.getMatchPlanner();
        System.out.println("total count is " + plannerX.totalCount);
        System.out.println("prune count is " + plannerX.pruneCount);

        Map<RelDigest, RelNode> relMap =
                com.alibaba.graphscope.gremlin.Utils.getFieldValue(
                        VolcanoPlanner.class, plannerX, "mapDigestToRel");
        int patternCount = 0;
        int intersectCount = 0;
        for (RelNode rel : relMap.values()) {
        ...
        System.out.println("pattern count is " + patternCount);
