...
public class PhysicalNode {
    public List<PhysicalNode> children;
    public ExecutionNode accept(ExecutionConvertor convertor, Context context) {
        return convertor.convert(this, context, this.children.stream().map(k -> k.accept(convertor, context)).collect(Collectors.toList()));
    }
}
