...
public class GraphTypeFactoryImpl extends JavaTypeFactoryImpl {
    ...
    public RelDataType createTypeWithNullability(RelDataType type, boolean nullable) {
        ...
        if (type instanceof GraphSchemaTypeList) {
            ...
            newType = GraphSchemaTypeList.create(Lists.newArrayList(schemaTypeList.listIterator()), nullable);
        } else if (type instanceof GraphSchemaType) {
            GraphSchemaType schemaType = (GraphSchemaType) type;
            newType = new GraphSchemaType(schemaType.getScanOpt(), schemaType.getLabelType(), schemaType.getFieldList(), nullable);
        } else {
