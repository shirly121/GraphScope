...
public interface IrCoreLibrary extends Library {
    ...
    FfiResult.ByValue addJoinKeyPairPb(Pointer join, FfiPbPointer.ByValue left, FfiPbPointer.ByValue right);

    FfiResult.ByValue appendJoinOperator(Pointer plan, Pointer join, int leftParent, int rightParent, IntByReference oprIdx);
}
