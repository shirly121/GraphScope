...
public class GraphHepPlanner extends HepPlanner {
    ...
    private class PlannerVisitor extends GraphRelVisitor {
        ...
        public RelNode visit(GraphLogicalExpandDegree degree) {
            return findBestIfRoot(degree, visitChildren(degree));
        }
        ...
        public RelNode visit(GraphExtendIntersect intersect) {
            return findBestIfRoot(intersect, intersect);
        }

        @Override
        public RelNode visit(GraphPattern graph) {
            return findBestIfRoot(graph, graph);
        }
