...
COPY --from=builder /home/graphscope/GraphScope/interactive_engine/executor/ir/core/resource/imdb_schema.yaml /home/graphscope/GIE/config/compiler/imdb_schema.yaml
